...
**Node.js** — [https://nodejs.org](https://nodejs.org) (download LTS)

**FFmpeg** — needed for GIF conversion:
- **Windows:** Download from [gyan.dev/ffmpeg](https://www.gyan.dev/ffmpeg/builds/), extract to `C:\ffmpeg`, add `C:\ffmpeg\bin` to PATH
...
Open the project in **Claude Code** (or any MCP-compatible AI coding tool), then type:

```
install the hyperframes skills
```

The AI will run `npx skills add heygen-com/hyperframes` automatically.
...
A folder picker will open. Select the folder containing your static design and elements. The system handles everything from there.
